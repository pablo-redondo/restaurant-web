  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-[18px]">
        {[
          { label: 'Total reseñas', value: reviews.length, delta: 'Reseñas verificadas', up: false, color: '#172E22' },
          { label: 'Rating medio',  value: avg !== null ? avg.toFixed(1) : '—', delta: 'Media global', up: false, color: '#B07010' },
          { label: 'Sin responder', value: 0, delta: 'Requieren atención', up: false, color: '#DC2626' },
