...
const contactInfo = [
  {
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C8DC2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>,
    label: 'Dirección',
  ...
  {
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C8DC2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
    label: 'Email',
    content: <span>info@marquesmadrid.es</span>,
  },
  {
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C8DC2E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8l5 3-5 3V8z"/></svg>,
    label: 'Metro',
