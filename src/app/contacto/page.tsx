  ...
  return (
    <>
      ...
      <section className="bg-[#172E22] px-[52px] py-16 border-b border-[#1E3020]">
        <p className="text-[#C8DC2E] text-[11px] font-bold tracking-[2.5px] uppercase mb-4">Encúntranos</p>
        <h1 className="font-hero font-[800] text-[64px] leading-[1.0] text-white mb-4">
          Dónde estamos
        </h1>
        <p className="text-[#8AB5A0] text-[17px] leading-[1.7] max-w-[480px]">
          ...
          <div>
            ...
            <div className="space-y-0">
              {horarios.map((h) => (
                <div
                  key={h.dias}
                  className={`flex items-baseline justify-between py-4 border-b border-[#D8E2DC] ${
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-[#172E22] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-heading font-semibold text-[15px] text-[#172E22] mb-1">Dirección</p>
                  <p className="text-[#5A6B60] text-[14px] leading-[1.65]">Calle Gran Vía, 45<br />28013 Madrid</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-heading font-semibold text-[15px] text-[#172E22] mb-1">Teléfono</p>
                  <p className="text-[#5A6B60] text-[14px]">+34 91 000 0000</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-heading font-semibold text-[15px] text-[#172E22] mb-1">Email</p>
                  <p className="text-[#5A6B60] text-[14px]">info@marquesmadrid.es</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-heading font-semibold text-[15px] text-[#172E22] mb-1">Metro</p>
                  <p className="text-[#5A6B60] text-[14px] leading-[1.65]">Gran Vía (L1, L5) · 3 min a pie<br />Callao (L3, L5) · 5 min a pie</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#172E22] px-[52px] py-[72px]">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-[28px] py-[14px] bg-white/8 border border-white/15 text-white text-[14px] font-medium rounded-[3px] hover:bg-white/12 transition"
          >
      ...
      <section className="bg-[#F0F4F0] px-[52px] py-[72px] border-t border-[#C4D5CA]">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex gap-3 flex-wrap">
            <Link href="/reservations" className="px-[28px] py-[13px] bg-[#172E22] text-white font-bold text-[14px] rounded-[3px] hover:bg-[#1E3A2A] transition">Reservar mesa →</Link>
            <Link href="/carta" className="px-[28px] py-[13px] border border-[#C4D5CA] text-[#172E22] text-[14px] rounded-[3px] hover:bg-[#E8EDE8] transition">Ver la carta</Link>
          </div>
        </div>
      </section>
    </>
