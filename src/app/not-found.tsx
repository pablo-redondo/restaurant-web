...
export default function NotFound() {
  return (
    <section
      className="bg-[#172E22] flex flex-col items-center justify-center px-5 sm:px-8 lg:px-[52px] py-32 text-center"
      style={{ minHeight: 'calc(100vh - 58px)' }}
    >
      <p className="text-[#C8DC2E] text-[11px] font-bold tracking-[2.5px] uppercase mb-5">Error 404</p>
      <h1 className="font-hero font-[800] text-[clamp(48px,14vw,72px)] leading-[1.02] text-white mb-5">
